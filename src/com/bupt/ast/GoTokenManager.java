/* Generated By:JJTree&JavaCC: Do not edit this line. GoTokenManager.java */
...
/** Constructor. */
public GoTokenManager(CharStream stream){
   input_stream = stream;
}

/** Constructor. */
public GoTokenManager(CharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
